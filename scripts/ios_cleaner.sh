...
killall -9 absd aosnotifyd calaccessd CallHistorySyncHelper com.apple.accounts.dom com.apple.datamigrator com.apple.quicklook.ThumbnailsAgent diagnosticd imagent itunesstored geod MobileMail medialibraryd routined Preferences SCHelper sharingd suggestd symptomsd useractivityd

killall -9 akd accountsd activationd aggregated askpermissiond assetsd atc backupd syncdefaultsd AppleIDAuthAgent aosnotifyd apsd AssetCacheLocatorService assetsd assistantd bird cfprefsd cdpd configd cloudd CloudKeychainProxy cmfsyncagent coreauthd dataaccessd familynotificationd fairplayd.H2 findmydeviced fmfd fmflocatord identityservices identityservicesd ind IDSKeychainSyncingProxy IDSRemoteURLConnectionAgent IMDMessageServicesAgent itunescloudd keybagd lskdd lockdown locationd mapspushd mobileactivationd nanoregistryd networkd notifyd nsurlsessiond nsurlstoraged online-auth-agent OTAPKIAssetTool passd pfd pkd profiled sbd securityd syncdefaultsd seld tccd
